...
var sampleExpenses: [Expense] = [
    ...
    Expense(remark: "Stocks", amount: 1399, date: Date(timeIntervalSince1970: 1652036845), type: .income, color: "Purple"),
    Expense(remark: "In App Purchase", amount: 5.99, date: Date(timeIntervalSince1970: 1651864045), type: .income, color: "Red"),
